    ...
    public partial class Form5 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    SqlCommand myCommand = new SqlCommand("insert into BANK values ('" + textBox1.Text.ToString() + "','" + textBox2.Text.ToString() +"','"+textBox3.Text.ToString() +"')", con);
                ...
                {
                    MessageBox.Show("Bank Code already exists");
                }
                finally
                {
                    con.Close();
